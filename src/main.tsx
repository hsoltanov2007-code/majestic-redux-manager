...
function App() {
  ...
  const [releaseVersion, setReleaseVersion] = useState("0.1.50");
  const [releaseNotes, setReleaseNotes] = useState("Hardy MODS Update");
  const [releaseUrl, setReleaseUrl] = useState(
    "https://github.com/hsoltanov2007-code/majestic-redux-manager/releases/download/v0.1.50/Hardy%20MODS_0.1.50_x64-setup.exe",
  );
