      ...
      <div className="w-full max-w-md glass-strong rounded-2xl shadow-elegant p-6">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <div className="font-semibold">
              {done ? "Installation complete" : "Installing redux"}
            </div>
            <div className="text-xs text-muted-foreground">
              {redux.name} · v{redux.version}
            </div>
          </div>
        </div>
        ...
        <div className="mt-5 flex justify-end gap-2">
          {done ? (
            <button
              onClick={onClose}
              className="px-4 py-2 rounded-lg text-sm font-medium gradient-primary text-primary-foreground shadow-glow"
            >
              Done
            </button>
          ) : (
            <button
              disabled
              className="px-4 py-2 rounded-lg text-sm font-medium bg-white/5 text-muted-foreground cursor-not-allowed inline-flex items-center gap-2"
            >
